    ...
    >
      <div className="bg-sky-800 text-white h-8 flex items-center justify-between p-2">
        <div className="flex gap-2 items-center pl-8">
          ...
          <p className="text-sm">info@northscapepakistan.com</p>
        </div>
          ...
          <div className="hidden lg:flex items-center space-x-8">
            {navItems.map((item) => (
              ...
              >
                <Link
                  href={item.href}
                  className={`flex items-center space-x-1 px-1 py-2 text-sm font-medium transition-colors duration-200  ${pathname === item.href
