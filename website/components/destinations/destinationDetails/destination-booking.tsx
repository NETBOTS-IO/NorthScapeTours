...
const DestinationBooking = ({ destination }: DestinationBookingProps) => {
  ...
  const handleBooking = async () => {
    ...
    // Basic validation
    if (!formData.departureDate || !formData.firstName || !formData.lastName || !formData.email || !formData.phone) {
                ...
                <CardContent className="p-0">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                      <div>
                        <Label htmlFor="departureDate" className="text-base font-semibold text-gray-900 mb-2 block">
                          Departure Date
                        </Label>
                ...
                <CardContent className="p-0">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="bg-green-50 p-4 rounded-lg">
                      ...
                      <p className="text-sm text-green-700 mt-1">Pay remaining balance 2 days before departure</p>
                    </div>
                  </div>
                  ...
                  >
                    ...
                    {loading ? "Processing..." : "Book Now - Pay Deposit"}
                  </Button>
                </CardContent>
              </Card>
