...
export const heroVideos: HeroVideo[] = [
  {
    id: "baltistan-mountain-expedition",
    title: "Baltistan Expedition",
    subtitle: "Journey through the towering peaks of Karakoram and experience the wild beauty of Skardu valleys.",
    posterUrl: "/images/mountain1.jpg?height=1080&width=1920&text=Baltistan+Postor",
    location: "Skardu, Gilgit-Baltistan",
    duration: 10,
    category: "Adventure",
    primaryCTA: "Start Expedition",
    secondaryCTA: "View Details",
  },

  {
    id: "hunza-handicrafts-tour",
    title: "Hunza Handicrafts Tour",
    subtitle: "Discover the rich cultural heritage of Hunza through handmade crafts, traditional art, and local mountain life experiences.",
    posterUrl: "/images/handicraft.jpg?height=1080&width=1920&text=Hunza+Postor",
    location: "Hunza, Gilgit-Baltistan",
    duration: 10,
    category: "Cultural Heritage",
    primaryCTA: "Explore Culture",
    secondaryCTA: "View Handicrafts",
   },
  // {
  //   id: "nangma-adventure",
